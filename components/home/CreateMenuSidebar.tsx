...
function CreateMenuSidebar() {
  return (
    <Menu as="div" className="relative">
      <Menu.Button
        className={cl(
          "relative flex w-full items-center justify-start pl-4 font-bold hover:after:absolute hover:after:inset-0 hover:after:block hover:after:rounded-sm hover:after:border-l-4 hover:after:border-[#a8b1ff]"
        )}
      >
        <h1>Create</h1>
        <ChevronDownIcon
